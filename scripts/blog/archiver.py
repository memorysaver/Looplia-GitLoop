#!/usr/bin/env python3
"""
Blog-specific archiver script.
Orchestrates archiving of Blog subscriptions.
"""
...
class BlogArchiver(BaseArchiver):
    """Blog-specific archiver."""
    ...
    def get_handler_class(self):
        """Return the handler class for Blog."""
        return BlogHandler
...
if __name__ == "__main__":
    ...
    config_path = BASE_DIR / "config" / "blog" / "sources.json"
    subscriptions_dir = BASE_DIR / "subscriptions"

    # Create archiver
    archiver = BlogArchiver(config_path, subscriptions_dir)
